...
import { createUsuario, updateUsuario, getRoles } from '../../services/userService';
...
const UserForm = ({ selectedUser, onSave }) => {
    ...
    // ✅ Si hay un usuario seleccionado para editar, se carga en el formulario
    useEffect(() => {
        if (selectedUser) {
    ...
    return (
        <form className="user-form" onSubmit={handleSubmit}>
            ...
            <input
                ...
                onChange={handleChange}
                required={!usuario.id} // Solo obligatorio si es un nuevo usuario
